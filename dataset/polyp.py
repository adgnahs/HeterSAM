...
def get_polyp_dataset(args, sam_trans=None):
    ...
    image_root = 'dataset/polyp/TrainDataset/images/'
    gt_root = 'dataset/polyp/TrainDataset/masks/'
    ds_train = PolypDataset(image_root, gt_root, augmentations=transform_train, sam_trans=sam_trans)
    image_root = 'dataset/polyp/TestDataset/test/images/'
    gt_root = 'dataset/polyp/TestDataset/test/masks/'
...
def get_tests_polyp_dataset(sam_trans):
    transform_train, transform_test = get_polyp_transform()
    image_root = 'dataset/polyp/TestDataset/Kvasir/images/'
    gt_root = 'dataset/polyp/TestDataset/Kvasir/masks/'
    ds_Kvasir = PolypDataset(image_root, gt_root, augmentations=transform_test, train=False, sam_trans=sam_trans)

    image_root = 'dataset/polyp/TestDataset/CVC-ClinicDB/images/'
    gt_root = 'dataset/polyp/TestDataset/CVC-ClinicDB/masks/'
    ds_ClinicDB = PolypDataset(image_root, gt_root, augmentations=transform_test, train=False, sam_trans=sam_trans)

    image_root = 'dataset/polyp/TestDataset/CVC-ColonDB/images/'
    gt_root = 'dataset/polyp/TestDataset/CVC-ColonDB/masks/'
    ds_ColonDB = PolypDataset(image_root, gt_root, augmentations=transform_test, train=False, sam_trans=sam_trans)

    image_root = 'dataset/polyp/TestDataset/ETIS-LaribPolypDB/images/'
    gt_root = 'dataset/polyp/TestDataset/ETIS-LaribPolypDB/masks/'
